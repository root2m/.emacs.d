    ...
    (defun lmm/evil-escape ()
      ...
      (when (evil-insert-state-p)
        (let ((modified (buffer-modified-p))
              ...
              (skey "k"))
          (insert "j")
          (let ((evt (read-event nil nil lmm/evil-key-dispath-delay)))
...
#+BEGIN_SRC emacs-lisp
  (use-package org
    ...
    (setq org-src-window-setup 'current-window
          ...
          ;; capture file
          org-default-notes-file (expand-file-name "org/capture-notes.org" user-emacs-directory))
...
#+BEGIN_SRC emacs-lisp
  (use-package vterm
    ...
    (general-define-key
     ...
     ;; "<f12>" (lambda (&optional count)(interactive "p") (if (one-window-p)
...
#+BEGIN_SRC emacs-lisp
  (use-package tramp
    :init
    (setq tramp-terminal-type "EmacsTramp")
    :config
    ...
    ;; 其他远程shell需要在配置开头加上
    ;; [[ $TERM == "EmacsTramp" ]] && PS1='$ ' && return
    ;; 或者 zsh:
    ;; [[ $TERM == "EmacsTramp" ]] && unsetopt zle && PS1='$ ' && return
